        ...
        <div className="container max-w-3xl">
          <AnimateIn>
            <div className="space-y-8 text-[#5B6472] text-sm leading-relaxed">
              ...
              <div><h2 className="text-xl font-semibold text-[#111315] mb-3">Our Services</h2><p>D&M Labs provides website design and development services for small businesses. We offer two main packages: Starter Website (€250) and Business Website (€350), plus optional monthly maintenance.</p></div>
              <div><h2 className="text-xl font-semibold text-[#111315] mb-3">Payment</h2><p>We split payment in two: 50% before we start work, and 50% before we launch your website. Prices are in Euros and do not include domain or hosting costs.</p></div>
