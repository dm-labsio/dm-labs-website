        ...
        <div className="container max-w-3xl">
          <AnimateIn>
            <div className="space-y-8 text-[#5B6472] text-sm leading-relaxed">
              <div><h2 className="text-xl font-semibold text-[#111315] mb-3">About These Terms</h2><p>These terms explain what you can expect from DM-Labs.io and what we expect from you. We've kept them simple and fair.</p></div>
              <div><h2 className="text-xl font-semibold text-[#111315] mb-3">Our Services</h2><p>DM-Labs.io provides website design and development services for businesses of all sizes. We offer website packages starting from €299, plus optional monthly maintenance plans.</p></div>
