      ...
      <article className="container max-w-3xl mx-auto py-16 px-4">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-[#374151]">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              <strong>Hosting:</strong> Ο server που φιλοξενεί την ιστοσελίδα σας κοστίζει €5-15 τον μήνα. Θέλουμε εσείς να είστε ιδιοκτήτες - σας βοηθάμε να επιλέξετε και να ρυθμίσετε το hosting.
            </p>
          </section>
