...
export default function TemplatesEl() {
  useSEO({
    title: "Παραδείγματα Ιστοσελίδων | Δείτε τη Δουλειά μας | D&M Labs",
    description: "Δείτε πραγματικά παραδείγματα ιστοσελίδων από τη D&M Labs για εστιατόρια, σαλόνια, οδοντιατρεία, στούντιο yoga και άλλα. Ξεκινώντας από €299.",
