...
const SERVICES: Record<string, {
  ...
  "custom-design": {
    ...
    whatWeDeliver: [
      ...
      "2 γύροι αναθεώρησης (Launch) / 3 γύροι (Growth) / 4 γύροι (Pro)",
    ],
    howItWorks: [
    ...
    faqs: [
      ...
      { q: "Πόσες σελίδες περιλαμβάνονται;", a: "Το πλάνο Launch περιλαμβάνει μια Branded Business Page. Το Growth περιλαμβάνει έως 4 σελίδες και το Pro έως 7 σελίδες. Επιπλέον σελίδες μπορούν να προστεθούν με μικρή επιπλέον χρέωση." },
  ...
  "seo": {
    ...
    faqs: [
      ...
      { q: "Προσφέρετε συνεχείς υπηρεσίες SEO;", a: "Το Complete Care πλάνο συντήρησής μας περιλαμβάνει μηνιαία παρακολούθηση SEO και μικρές βελτιστοποιήσεις. Πλήρεις καμπάνιες content marketing και link building είναι διαθέσιμες ως ξεχωριστή υπηρεσία." },
