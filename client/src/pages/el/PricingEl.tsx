...
export default function PricingEl() {
  ...
  return (
    <div className="pricing-editorial pricing-journey" lang="el">
      ...
      <section className="pricing-editorial-cta-section section-spacing"><div className="container max-w-3xl text-center"><AnimateIn><h2 className="pricing-editorial-cta-heading">Δεν είστε σίγουροι ποιο <em>πακέτο</em> ταιριάζει;</h2><p>Πείτε μας τι χρειάζεται η επιχείρησή σας και θα προτείνουμε το σωστό αρχικό scope.</p><div className="pricing-editorial-cta-actions flex flex-col sm:flex-row gap-4 justify-center"><Link href="/el/contact/" className="btn-primary"><MessageCircle size={18} /> Κλείστε Δωρεάν Συμβουλευτική</Link><a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="btn-secondary">WhatsApp <ArrowRight size={16} /></a></div></AnimateIn></div></section>
    </div>
  );
}
