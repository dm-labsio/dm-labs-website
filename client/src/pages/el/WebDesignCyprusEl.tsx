    ...
    <main className="bg-[#F6F6F4] min-w-0 overflow-x-hidden">
      ...
      <section className="section-spacing bg-white">
        <div className="container max-w-4xl mx-auto">
          <AnimateIn>
            <h2 className="text-3xl font-bold text-[#111315] mb-4">
              Γιατί να Επιλέξετε τη DM-Labs.io για Κατασκευή Ιστοσελίδας στην Κύπρο
            </h2>
            <p className="text-[#5B6472] mb-10 leading-relaxed">
              Υπάρχουν δεκάδες <strong>web designers στην Κύπρο</strong>. Αυτό που κάνει τη DM-Labs.io διαφορετική:
            </p>
          </AnimateIn>
      ...
      <section className="section-spacing bg-white">
        <div className="container max-w-4xl mx-auto">
          <AnimateIn>
            ...
            <p className="text-[#5B6472] mb-10 leading-relaxed">
              Η απόκτηση μιας <strong>επαγγελματικής ιστοσελίδας στην Κύπρο</strong> με τη DM-Labs.io είναι μια απλή διαδικασία τεσσάρων βημάτων:
            </p>
          </AnimateIn>
        ...
        <div className="container max-w-4xl mx-auto">
          <AnimateIn>
            ...
            <p className="text-[#5B6472] mb-8 leading-relaxed">
              Η DM-Labs.io συνεργάζεται με επιχειρήσεις σε όλη την Κύπρο - από Λεμεσό και Λευκωσία μέχρι Λάρνακα, Πάφο, Αμμόχωστο, Παραλίμνι και κάθε επαρχία ενδιάμεσα. Εξυπηρετούμε επίσης επιχειρήσεις στην Ελλάδα (Αθήνα, Θεσσαλονίκη) και διεθνώς. Η απόσταση δεν αποτελεί ποτέ παράγοντα.
            </p>
          </AnimateIn>
