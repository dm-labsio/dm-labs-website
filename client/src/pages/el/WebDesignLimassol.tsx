...
const faqs = [
  {
    ...
    a: "Τα πακέτα κατασκευής ιστοσελίδων μας για επιχειρήσεις στη Λεμεσό ξεκινούν από €299 για το Launch Website, €749 για το Growth Website και €1,499 για το Pro Website. Τα Enterprise / Custom έργα ξεκινούν από €1,499 και κοστολογούνται όπως αναφέρεται στην προσφορά σας. Όλα τα πακέτα περιλαμβάνουν mobile-responsive design, παραμετροποίηση SEO και φόρμα επικοινωνίας. Αυτές είναι εισαγωγικές τιμές για περιορισμένο χρονικό διάστημα - δείτε τη σελίδα Τιμές για την πλήρη ανάλυση.",
  },
  {
