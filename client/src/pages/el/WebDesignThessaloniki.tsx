...
const faqs = [
  {
    ...
    a: "Τα πακέτα μας για επιχειρήσεις στη Θεσσαλονίκη ξεκινούν από €299 για το πακέτο Launch Website. Αυτό περιλαμβάνει πλήρως προσαρμοσμένο σχεδιασμό, responsive για κινητά, αρχική ρύθμιση SEO, φόρμα επικοινωνίας και όλα όσα χρειάζεστε για να βγείτε online. Το πακέτο Growth Website ξεκινά από €749 και το Pro Website από €1,499. Τα Enterprise / Custom έργα ξεκινούν από €1,499 και κοστολογούνται όπως αναφέρεται στην προσφορά σας. Οι τιμές εξαρτώνται από τις απαιτήσεις του έργου, γι\
