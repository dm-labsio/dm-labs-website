...
const faqs = [
  {
    ...
    a: "Τα πακέτα μας για επιχειρήσεις στη Θεσσαλονίκη ξεκινούν από €249 για το πακέτο Starter. Αυτό περιλαμβάνει πλήρως προσαρμοσμένο σχεδιασμό, responsive για κινητά, αρχική ρύθμιση SEO, φόρμα επικοινωνίας και όλα όσα χρειάζεστε για να βγείτε online. Το πακέτο Business ξεκινά από €399 και το Premium από €699. Οι τιμές εξαρτώνται από τις απαιτήσεις του έργου, γι\
' αυτό συνιστούμε πάντα μια δωρεάν συμβουλευτική συνάντηση πρώτα - με αυτόν τον τρόπο λαμβάνετε μια ακριβή προσφορά χωρίς εκπλήξεις.",
  ...
  },
  {
    ...
    a: "Το πακέτο Starter συνήθως παραδίδεται εντός 5 έως 7 ημερών από τη στιγμή που έχουμε το περιεχόμενο και την ανατροφοδότησή σας. Τα πακέτα Business και Premium χρειάζονται 10 έως 14 ημέρες, ανάλογα με τον αριθμό των σελίδων και τυχόν προσαρμοσμένες λειτουργίες. Σας κρατάμε ενήμερους καθ' όλη τη διάρκεια και δεν εξαφανιζόμαστε μεταξύ των οροσήμων.",
  },
];

export default function WebDesignThessalonikiEl() {
  useSEO({
    title: "Κατασκευή Ιστοσελίδας Θεσσαλονίκη | Επαγγελματικές Ιστοσελίδες από €249 | D&M Labs",
    description:
      ...
      <section className="section-spacing bg-gradient-to-br from-[#F0F4FF] via-[#F6F6F4] to-[#F0EAFF]">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#5B6472] max-w-2xl mx-auto mb-8 leading-relaxed">
            Η D&M Labs είναι ένα απομακρυσμένο στούντιο web design που βοηθά τις επιχειρήσεις στη Θεσσαλονίκη να χτίσουν μια ισχυρή, αξιόπιστη online παρουσία. Παραδίδουμε γρήγορες, mobile-first και εστιασμένες στη μετατροπή ιστοσελίδες - ξεκινώντας από €249 - ώστε η επιχείρησή σας να ξεχωρίζει στη δεύτερη μεγαλύτερη πόλη της Ελλάδας.
          </p>
