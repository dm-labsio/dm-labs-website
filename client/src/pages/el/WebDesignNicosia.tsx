        ...
        <div className="container max-w-4xl mx-auto text-center">
          <AnimateIn>
            ...
            <p className="text-lg text-[#5B6472] max-w-2xl mx-auto mb-8 leading-relaxed">
              Η DM-Labs.io είναι ένα στούντιο σχεδιασμού ιστοσελίδων που βοηθά τις επιχειρήσεις στη Λευκωσία να χτίσουν μια ισχυρή, αξιόπιστη online παρουσία. Παραδίδουμε γρήγορες, mobile-first και εστιασμένες στη μετατροπή ιστοσελίδες — ξεκινώντας από €249 — ώστε η επιχείρησή σας να ξεχωρίζει στην πρωτεύουσα της Κύπρου.
            </p>
