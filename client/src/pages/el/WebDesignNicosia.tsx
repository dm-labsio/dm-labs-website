...
const faqs = [
  {
    ...
    a: "Τα πακέτα μας ξεκινούν από €299 για μια ιστοσελίδα Launch Website — μια πλήρως προσαρμοσμένη, responsive για κινητά ιστοσελίδα με εγκατάσταση SEO, φόρμα επικοινωνίας και όλα όσα χρειάζεστε για να βγείτε live. Το πακέτο Growth Website ξεκινά από €749 και το Pro Website από €1,499. Τα Enterprise / Custom έργα ξεκινούν από €1,499 και κοστολογούνται όπως αναφέρεται στην προσφορά σας. Πάντα προτείνουμε μια δωρεάν συμβουλευτική συνάντηση πρώτα, ώστε να λάβετε μια ακριβή προσφορά χωρίς εκπλήξεις."
  },
  {
