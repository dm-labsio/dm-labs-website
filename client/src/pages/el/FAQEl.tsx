...
const faqs = [
  {
    ...
    items: [
      ...
      { q: "Πόσο καιρό χρειάζεται για να φτιαχτεί η ιστοσελίδα μου;", a: "Οι ιστοσελίδες Launch παραδίδονται σε 5-7 εργάσιμες μέρες. Οι Growth ιστοσελίδες σε 7-10 εργάσιμες μέρες. Το χρονοδιάγραμμα ξεκινά μόλις λάβουμε το περιεχόμενό σας και επιβεβαιώσουμε το εύρος του project." },
      ...
      { q: "Μπορώ να αναβαθμίσω το πλάνο μου αργότερα;", a: "Απολύτως. Αν ξεκινήσετε με το Launch πλάνο και αργότερα αποφασίσετε ότι χρειάζεστε περισσότερες σελίδες ή λειτουργίες, μπορούμε να αναβαθμίσουμε την ιστοσελίδα σας ανά πάσα στιγμή. Πληρώνετε μόνο τη διαφορά μεταξύ των πλάνων." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Μπορώ να κάνω αλλαγές αφού η ιστοσελίδα είναι ζωντανή;", a: "Ναι. Μικρές αλλαγές κειμένου είναι δωρεάν για τον πρώτο μήνα μετά το launch. Μετά από αυτό, τα πλάνα συντήρησής μας (από €69/μήνα) καλύπτουν συνεχείς ενημερώσεις, ή μπορείτε να ζητήσετε μεμονωμένες αλλαγές." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Τι περιλαμβάνει το πλάνο συντήρησης;", a: "Προσφέρουμε δύο επίπεδα: Basic Care (€69/μήνα) καλύπτει έως 3 μικρές ενημερώσεις περιεχομένου τον μήνα, παρακολούθηση hosting, backups και υποστήριξη WhatsApp. Complete Care (€129/μήνα) προσθέτει απεριόριστες λογικές ενημερώσεις, προτεραιότητα απόκρισης, μηνιαίους ελέγχους απόδοσης, εποχιακά banners και προσθήκες νέων ενοτήτων. Χωρίς συμβόλαια - ακύρωση ανά πάσα στιγμή." },
