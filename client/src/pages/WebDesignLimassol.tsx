  ...
  return (
    <main className="bg-white">
      ...
      <section className="section-spacing bg-[#F8F9FC]">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#111315] mb-3">
            What Limassol Clients Say
          </h2>
          <p className="text-[#5B6472] mb-10">
            We are actively working with businesses in Limassol. Reviews coming soon.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-6 border border-dashed border-[#D1D5DB] flex flex-col gap-3"
              >
                <div className="flex gap-1">
                  {[...Array(5)].map((_, s) => (
                    <svg key={s} className="w-4 h-4 text-[#D1D5DB]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className="text-[#9CA3AF] text-sm italic">
                  "Client review from Limassol coming soon..."
                </p>
                <div className="mt-auto">
                  <div className="h-2 bg-[#F3F4F6] rounded w-24 mb-1" />
                  <div className="h-2 bg-[#F3F4F6] rounded w-16" />
                </div>
              </div>
            ))}
          </div>
