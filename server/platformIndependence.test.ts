...
describe("platform-independent production stack", () => {
  ...
  it("preserves the production build, output directory, and 93-route prerender contract", () => {
    ...
    expect(literalRoutes.length + englishBlogSlugs.length + greekBlogSlugs.length).toBe(93);
